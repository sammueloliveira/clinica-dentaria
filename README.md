...
- **ASP.NET MVC**: Framework para desenvolvimento da interface web, permitindo uma estrutura organizada e escalável.
- **ASP.NET Core**: Utilizado para a construção de APIs que facilitam a comunicação com o front-end.
...
- **Injeção de Dependência**: Gestão de dependências para um código mais limpo e modular.
